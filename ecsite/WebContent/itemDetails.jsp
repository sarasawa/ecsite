		...
		<div>
			...
			<s:elseif test = "message == null">
				...
				<table border = "1">
					...
					<tr>
						<th>商品名</th>
						<td><s:property value = "itemDetailsDTO.item_name"/></td>
					</tr>
					<tr>
						<th>値段</th>
						<td><s:property value = "itemDetailsDTO.item_price"/></td>
					</tr>
					<tr>
							<th>在庫</th>
							<td><s:property value="itemDetailsDTO.item_stock" /><span>個</span></td>
						</tr>
						<tr>
							<th>登録日</th>
