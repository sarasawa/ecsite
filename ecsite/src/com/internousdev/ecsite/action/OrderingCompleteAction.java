...
public class OrderingCompleteAction extends ActionSupport implements SessionAware{
	...
	public String execute() throws SQLException {
		...
		for(ItemInfoDTO list : itemList){
			int item_stock = Integer.parseInt(list.getItem_stock());
			int stock = item_stock + list.getOrderCount();
